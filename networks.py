...
class HGNNModel(nn.Module):
    def __init__(self, V_H, hidden_dims=[15, 15, 1]):
        ...
        nn.init.xavier_uniform_(self.theta_3, gain=0.1)

        # Add batch normalization layers
        self.bn1 = nn.BatchNorm1d(hidden_dims[0], momentum=0.05, dtype=torch.float64)
        self.bn2 = nn.BatchNorm1d(hidden_dims[1], momentum=0.05, dtype=torch.float64)
